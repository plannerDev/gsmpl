...
public:
    ...
    PathSimplifier(const LocalPlannerBasePtr& localPlanner,
    ...
    Path reduceVertices(const Path& rawPath, double stepSizeJps,
                        double stepSizeTcp, unsigned int maxSteps = 0,
                        unsigned int maxEmptySteps = 10,
                        double rangeRatio = 0.33);
    Path collapseCloseVertices(const Path& rawPath, double stepSizeJps,
                               double stepSizeTcp, unsigned int maxSteps = 0,
    ...
    Trajectory generateTrajector(const Path& path, double stepSizeJps,
                                 double stepSizeTcp) const;
