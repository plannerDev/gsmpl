...
namespace gsmpl {
State JointInterpolateSimple::interpolateState(const State& q1, const State& q2, double time) const
{
...
std::optional<State> JointInterpolateSimple::validInterpolateState(const State& q1, const State& q2,
                                                                   double time) const
{
...
std::optional<Path> JointInterpolateSimple::validInterpolatePath(const State& q1, const State& q2,
                                                                 double jpsStepSize,
...
Path JointInterpolateSimple::interpolatePath(const State& q1, const State& q2, double jpsStepSize,
                                             double tcpStepSize) const
{
    Path path;
    unsigned int steps = floor(abs(distance_->distance(q1, q2)) / jpsStepSize);
